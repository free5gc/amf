...
func handleHandoverRequestAcknowledgeMain(ran *context.AmfRan,
	...
	if sourceUe == nil {
		...
		n2InfoBinaryData, err := libngap.Encoder(ngapType.NGAPPDU{
			...
			SuccessfulOutcome: &ngapType.SuccessfulOutcome{
				ProcedureCode: ngapType.ProcedureCode{
					Value: ngapType.ProcedureCodeHandoverResourceAllocation,
				},
					...
					HandoverRequestAcknowledge: &ngapType.HandoverRequestAcknowledge{
						ProtocolIEs: ngapType.ProtocolIEContainerHandoverRequestAcknowledgeIEs{
							List: []ngapType.HandoverRequestAcknowledgeIEs{
								...
								{
									Id: ngapType.ProtocolIEID{
										Value: ngapType.ProtocolIEIDPDUSessionResourceAdmittedList,
									},
									Criticality: ngapType.Criticality{
										Value: ngapType.CriticalityPresentIgnore,
									},
								...
								{
									Id: ngapType.ProtocolIEID{
										Value: ngapType.ProtocolIEIDPDUSessionResourceFailedToSetupListHOAck,
									},
									Criticality: ngapType.Criticality{
										Value: ngapType.CriticalityPresentIgnore,
									},
									Value: ngapType.HandoverRequestAcknowledgeIEsValue{
										Present:                                  ngapType.HandoverRequestAcknowledgeIEsPresentPDUSessionResourceFailedToSetupListHOAck,
										PDUSessionResourceFailedToSetupListHOAck: pDUSessionResourceFailedToSetupListHOAck,
									},
								},
								{
									Id: ngapType.ProtocolIEID{
										Value: ngapType.ProtocolIEIDTargetToSourceTransparentContainer,
									},
									Criticality: ngapType.Criticality{
								...
								},
								{
									...
									Value: ngapType.HandoverRequestAcknowledgeIEsValue{
										Present:                ngapType.HandoverRequestAcknowledgeIEsPresentCriticalityDiagnostics,
		...
		binaryDataTarget2SourceTransparentContainer, err := aper.MarshalWithParams(targetToSourceTransparentContainer, "referenceFieldValue:106")

		resp201 := models.CreateUeContextResponse201{
			JsonData:                &ueContextCreatedData,
			BinaryDataN2Information: binaryDataTarget2SourceTransparentContainer,
		}
	} else {
